...
public class Event {
	 ...
	 */
	protected static JSONObject buildInput(long duration, String lang, String reference, String summary, String url) throws JSONException {
	 ...
	 * @throws JSONException 
	 */
	public static Event parseDetails(String rawJson) throws JSONException {
